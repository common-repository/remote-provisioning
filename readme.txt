...
= WHMCS addon compatibility =
* Plugin v1.5.x compatible with WHMCS addon v1.5.x
* Plugin v1.4.x compatible with WHMCS addon v1.4.x-v1.5.1
* Plugin v1.3.x compatible with WHMCS addon v1.3.x
* Plugin v1.2.x compatible with WHMCS addon v1.2.x
* Plugin v1.1.x compatible with WHMCS addon v1.1.x
* Plugin v1.0.x compatible with WHMCS addon v1.0.x
* Plugin v0.9.x compatible with WHMCS addon v0.9.x
